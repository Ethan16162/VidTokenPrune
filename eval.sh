...
# --output_path ./logs_retain_10_percent/llava_video_hieravid_float16_newest/
...
-m lmms_eval \
--model llava_onevision \
--model_args pretrained=lmms-lab/llava-onevision-qwen2-7b-ov,conv_template=qwen_1_5,max_frames_num=64 \
--tasks egoschema_subset \
--batch_size 1 \
--log_samples \
--log_samples_suffix llava_onevision_float16 \
--output_path ./logs_retain_20_percent/llava_onevision_hieravid_float16_frame32
...
# --tasks nextqa_oe_test,mvbench,videomme,videomme_w_subtitle \
# --batch_size 1 \
# --log_samples \
# --log_samples_suffix llava_onevision_float16 \
